            ...
            xl:flex xl:h-[72px] xl:items-center">
                <div className="flex items-center justify-between text-brand-dark h-14 px-[23px] md:px-8 xl:px-0 xl:mx-10 xl:mr-5">
                    ...
                    <div className="hidden xl:flex justify-center items-center">
                        ...
                        <nav className="font-[645] ml-6">
                            <Link to="/products" onClick={toggleMenu} className="px-4 hover:text-brand-light">Products</Link>
                            <Link to="/industries" onClick={toggleMenu} className="px-4 hover:text-brand-light">Industries</Link>
                            <Link to="/" onClick={toggleMenu} className="px-4 hover:text-brand-light">Customers</Link>
                            <Link to="/" onClick={toggleMenu} className="px-4 hover:text-brand-light">Learning</Link>
                            <Link to="/support" onClick={toggleMenu} className="px-4 hover:text-brand-light">Support</Link>
                            <Link to="/impact" onClick={toggleMenu} className="px-4 hover:text-brand-light">Company</Link>
                ...
                <div id="mobile-menu"
                    ...
                    <nav>
                        ...
                        <Link to="/impact" onClick={toggleMenu} className="flex py-[7px] justify-between hover:text-brand-light">Company
                            <img src="assets/images/icons/arro-icon.svg" alt="arrow" className="size-9" />
                        </Link>
                        <Link to="/" onClick={toggleMenu} className="flex py-[7px] justify-between hover:text-brand-light">Salesforce+
                            <img src="assets/images/icons/arro-icon.svg" alt="arrow" className="size-9" />
                        </Link>
                    </nav>
                    <div className="pt-7">
